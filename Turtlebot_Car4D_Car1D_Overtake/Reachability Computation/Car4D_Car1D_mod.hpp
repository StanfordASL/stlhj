#ifndef __Car4D_Car1D_mod_hpp__
#define __Car4D_Car1D_mod_hpp__
...
namespace helperOC {
	/*
		...
		aMin <= a <= aMax
	*/
	class Car4D_Car1D_mod : public DynSys {
	public:
	protected:
		...
		std::vector<beacls::FloatVec> slope_Coefficient;
    std::vector<beacls::FloatVec> intercept_Coefficient;
		FLOAT_TYPE dt;
	...
	public:
		...
		*/
		...
		PREFIX_VC_DLL
			virtual ~Car4D_Car1D_mod();
		PREFIX_VC_DLL
			virtual bool operator==(const Car4D_Car1D_mod& rhs) const;
		PREFIX_VC_DLL
			virtual bool operator==(const DynSys& rhs) const;
		virtual Car4D_Car1D_mod* clone() const {
			return new Car4D_Car1D_mod(*this);
		}
		PREFIX_VC_DLL
			virtual bool save(
				beacls::MatFStream* fs,
	...
	private:
		...
		Disable operator=
		*/
		Car4D_Car1D_mod& operator=(const Car4D_Car1D_mod& rhs);
		/** @overload
		Disable copy constructor
		*/
		Car4D_Car1D_mod(const Car4D_Car1D_mod& rhs) :
			DynSys(rhs),
		...
		void ComputeCompatibleController(
		    FLOAT_TYPE& uOpt0_i,
		    FLOAT_TYPE& uOpt1_i,
